...
//根据native初始化设置的dartEntrypoint来看是哪个入口，main函数必须要存在否则无法编译
void main() {
  runApp(MyApp());
}

//根据native初始化设置的dartEntrypoint来看是哪个入口
void mainDev() {
  runApp(MyApp());
}
...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    // 添加navigationObserver，用于控制返回操作，只针对用Navigator.push<dynamic>打开的flutter页面，
    // 详见下面的“flutter两种打开页面的方式”，除了Navigator的其他方式只能监听到push监听不到pop
